...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://filestore24april:filestore24april@cluster0.whlul8v.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
